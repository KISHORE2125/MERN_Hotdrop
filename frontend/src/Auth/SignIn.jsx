...
const SignIn = () => {
  ...
  // Redirect to backend OAuth start. Use Vite env variable (VITE_API_URL) in this project.
      ...
      >
        ...
        <form className="mt-6 space-y-4" onSubmit={handleSubmit}>
          ...
          <div className="flex items-center justify-between text-xs">
            ...
            <button type="button" className="text-red-500 hover:underline font-medium">
              Forgot Password?
            </button>
          </div>
        ...
        >
          <FcGoogle size={20} /> {googleLoading ? "Signing in..." : "Sign in with Google"}
        </motion.button>

        <p className="text-center text-gray-600 text-xs mt-4">
          Don’t have an account?{" "}
          <button className="text-red-500 hover:underline font-semibold">Sign Up</button>
        </p>
      </motion.div>
    </section>
  );
